...
<body>
    ...
    <div class="page">
        <div class="header-area">
            ...
            <button class="button" id="btnAddUser" onclick="window.location.href='form.php';">ADD USER</button>
            <button class="button" id="btnAddUser" onclick="window.location.href='form1.php';">MANAGE FACULTY</button>
        </div>
