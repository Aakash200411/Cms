...
if (isset($_POST['roll_no']) && isset($_POST['name']) && isset($_POST['email']) && isset($_POST['session_id']) && isset($_POST['course_ids'])) {
    ...
    $conn_attendance = new mysqli('mysql.railway.internal', 'root', 'llBhSnJhgoNktIPCqMYyNgPPAPJRdalt', 'railway');
    ...
    if ($stmt->execute()) {
        ...
        $conn_cms = new mysqli('mysql.railway.internal', 'root', 'llBhSnJhgoNktIPCqMYyNgPPAPJRdalt', 'railway');
